...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="providers", to="core.category"
                    ),
                ),
                (
                    "region",
        ...
        migrations.AddIndex(
            model_name="provider",
            index=models.Index(
                fields=["verification_status"], name="providers_verific_9bf07a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="provider",
            index=models.Index(
                fields=["is_available"], name="providers_is_avai_b2218e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="provider",
            index=models.Index(
                fields=["region", "is_available"], name="providers_region__fb779d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="provideronboarding",
            index=models.Index(
                fields=["status", "-submitted_at"], name="provider_on_status_5d5ba8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="provideronboarding",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="provider_on_region__12b5e4_idx",
            ),
        ),
    ]
